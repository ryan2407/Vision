		...
		function output_msg_sites_page( $msg ) {
			switch( $_GET['action'] ) {
				...
				case 'not_rebuildindexing':		$msg = __('Index could not be scheduled for rebuilding for the requested site.','postindexer');
												break;
				case 'changed_siteindexing':	$msg = __('Your settings have been updated for the requested site.','postindexer');
												break;
			}
								...
								<tr>
									...
									<td>
										<?php
											$indexing = get_option( 'postindexer_active', 'yes' );
										?>
										<label><input type='radio' name='postindexer_active' value='yes' <?php checked($indexing, 'yes'); ?> />&nbsp;<?php _e('Enabled', 'postindexer'); ?></label>&nbsp;&nbsp;
										<label><input type='radio' name='postindexer_active' value='no' <?php checked($indexing, 'no'); ?> />&nbsp;<?php _e('Disabled', 'postindexer'); ?></label>
									</td>
								</tr>
							</tbody>
						</table>
